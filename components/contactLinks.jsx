  ...
  return (
    <section className="flex flex-col items-center gap-4 mt-10">
      <a
        ...
        className="w-full max-w-xs rounded-xl bg-pink-600 px-6 py-3 text-center font-semibold text-white hover:bg-pink-700 transition"
      >
        <svg
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-full max-w-xs rounded-xl bg-green-600 px-6 py-3 text-center font-semibold text-white hover:bg-green-700 transition"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
